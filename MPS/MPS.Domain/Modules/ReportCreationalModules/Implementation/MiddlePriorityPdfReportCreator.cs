...
public class MiddlePriorityPdfReportCreator : IReportCreator
{
    private readonly AccountDto _account;
    private readonly IReadOnlyCollection<AccountDto> _subordinates;

    public MiddlePriorityPdfReportCreator(AccountDto account, IReadOnlyCollection<AccountDto> subordinates)
    {
        _account = account;
